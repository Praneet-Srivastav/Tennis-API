...
' Function to check if a match involves WTA players
Function CheckWTAMatch(homePlayer As String, awayPlayer As String) As String
    Dim http As Object
    Dim url As String
    Dim jsonBody As String
    Dim response As String
...
' Subroutine for bulk processing WTA players
Sub BulkCheckWTAPlayers(homeRange As Range, awayRange As Range, resultRange As Range)
    Dim i As Long
    ...
    For i = 1 To homeRange.Rows.Count
        ...
        If currentBatch = batchSize Or i = homeRange.Rows.Count Then
            ...
            Call ParseBulkResponse(response, resultRange, i - currentBatch + 1, currentBatch)
...
' Helper function to parse bulk response
Private Sub ParseBulkResponse(response As String, resultRange As Range, startRow As Long, count As Integer)
    Dim i As Integer
    Dim pos As Long
...
End Sub
' Alternative function for detailed analysis (slower but more informative)
Function CheckWTAMatchDetailed(homePlayer As String, awayPlayer As String) As String
    ' This is the new detailed function (same as CheckWTAMatch above)
    ' Use this when you want detailed feedback
    CheckWTAMatchDetailed = CheckWTAMatch(homePlayer, awayPlayer)
End Function

' Simple function for bulk processing (faster, returns only "WTA" or empty)
Function CheckWTAMatchSimple(homePlayer As String, awayPlayer As String) As String
    Dim http As Object
    Dim url As String
    Dim jsonBody As String
    Dim response As String
...
' Updated bulk processing to use simple function for speed
Private Sub ParseBulkResponse(response As String, resultRange As Range, startRow As Long, count As Integer)
    Dim i As Integer
    Dim pos As Long
    Dim isWTAPos As Long
